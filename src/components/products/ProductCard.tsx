...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <article className="group overflow-hidden bg-[#F4F5F7]">
      ...
      <div className="px-5 pb-5">
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-md bg-green-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-green-700"
        >
          <FaWhatsapp />
          Order on WhatsApp
        </a>
